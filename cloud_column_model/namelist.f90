...
&RECORD0
  exp_type   =       1          ! Type of experiment to run (1 = single model run, 4 = ensemble)
  ...
  run_time   =       3.         ! Model run time (hours)
...
! Observations
&RECORD2
  n_obs_times   = 6  ! Number of observation times (max is hard coded in "crm_model_error.f90"
  obs_times     =  30.,  60.,  90., 120., 150., 180.   ! Observation times (in minutes since start of model run)
